...
/**
 * A classe usuário é responsável por gerenciar todas as operações relacionadas à usuários
 */
class Usuario {
    /**
     * O construtor recebe os dados de um usuário e os atribui à instânica atual
    ...
    /**
     *
     * @throws {InvalidArgumentError} - este erro ocorre quando um usuário o mesmo e-mail já está cadastrado
     */
    async adiciona() {
